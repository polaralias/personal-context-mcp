...
This service exists to give agents trustworthy personal context with minimal ambiguity.

The value is not in storing raw events. The value is in answering context questions correctly and predictably.

## User of the product

The primary user is another machine agent.
